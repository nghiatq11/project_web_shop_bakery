...
<html>
    ...
    <body>
        ...
        <%
            ...
            Integer countAllProductByFilterPrice = (Integer) request.getAttribute("countAllProductByFilterPrice");
            int idFilterPrice = (int) request.getAttribute("idFilterPrice");
        %>
            ...
            <div class="row">
                <div class="col-lg-9 col-lg-9a">
                    <div class="noo-catalog row">
                        <% if (countAllProductByFilterPrice >= pageIndex * 9) {%>
                        <p class="commerce-result-count">Đang xem <%= 9 * (pageIndex - 1) + 1%>–<%= 9 * pageIndex%>  trên <%= countAllProductByFilterPrice%> Sản phẩm</p>
                        <%} else {%>

                        <p class="commerce-result-count">Đang xem <%= 9 * (pageIndex - 1) + 1%>–<%= countAllProductByFilterPrice%>  trên <%= countAllProductByFilterPrice%> Sản phẩm</p>
                        <%}%>
                    ...
                    <div class="page container">
                        <%= Helper.pager(pageIndex, pageCount, 2, "get-products-by-filter-price?idFilterPrice=" + idFilterPrice + "&page=")%>
                    </div>
                </div>
